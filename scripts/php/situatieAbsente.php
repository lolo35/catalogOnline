  ...
  <div class="row">
    ...
    <div class="col-sm-6" style="background-color: white;">
      ...
      <script type="text/javascript">
        ...
        function testFunction(e, legendItem){
          //console.log(legendItem[0]._view.label);
          $.ajax({
            method: "GET",
            url: "scripts/php/detailedClassChart.php?clasa=" + legendItem[0]._view.label ,
            cache: false,
            success: function(data){
              $("#detailedClassChart").hide("fold", {direction: "up"}, "slow", function(){
                $("#detailedClassChart").html("");
                $("#detailedClassChart").html(data);
                $("#detailedClassChart").show("fold", {direction: "down"}, "slow", function(){
